...
export class FormModal {
  constructor () {
    ...
    this.closeButton = document.querySelectorAll('.form-modal button.modal-close')[0]
    ...
    //listener submit
    this.submitButton = document.querySelectorAll('.form-modal button.button')[0]
    ...
    //listener phone
    this.inputPhone = document.querySelectorAll('.form-modal input[name="phone"]')[0]
  ...
  closeModal (e) {
    this.formModal = document.querySelectorAll('.form-modal')[0]
    this.formModal.classList.toggle('is-hidden')
  }
  ...
  submitModal (e) {
    this.form = document.querySelectorAll('.form-modal .form input')
    this.hasError = true
